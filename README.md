...
Блок со списком ответов в виде картинок с одним правильным ответом:

***ВНИМАНИЕ! Спецификация следующиего блока пока утверждается***

```javascript
{{текст вопроса :? {-img 'http://link1.com/'--}, {-img 'http://link2.com/'--}, {-img 'http://linkN.com/'--} :: {-img 'http://link2.com/'--}}}
```
