...
*/
var parser = (function(){
var o=function(k,v,o,l){for(o=o||{},l=k.length;l--;o[k[l]]=v);return o},$V0=[1,8],$V1=[1,9],$V2=[1,10],$V3=[1,11],$V4=[1,6],$V5=[4,5,6,7,24,29],$V6=[2,3],$V7=[1,25],$V8=[1,26],$V9=[1,27],$Va=[1,28],$Vb=[4,5,6,7],$Vc=[1,34],$Vd=[1,35],$Ve=[6,10,11],$Vf=[2,9];
var parser = {trace: function trace() { },
yy: {},
symbols_: {"error":2,"symbol":3,"char":4,"SP":5,"SEP":6,"special_symbol":7,"phrase":8,"AM":9,"+":10,"-":11,"answer":12,"answers":13,"question":14,"type":15,"TEXT":16,"VIDEO":17,"AUDIO":18,"IMAGE":19,"type_marker":20,"test_block":21,"test_blocks":22,"tests_section":23,"TESTS":24,"TESTS_END":25,"statement":26,"source":27,"file":28,"EOF":29,"$accept":0,"$end":1},
terminals_: {2:"error",4:"char",5:"SP",6:"SEP",7:"special_symbol",10:"+",11:"-",16:"TEXT",17:"VIDEO",18:"AUDIO",19:"IMAGE",24:"TESTS",25:"TESTS_END",29:"EOF"},
...
table: [{3:7,4:$V0,5:$V1,6:$V2,7:$V3,8:5,23:4,24:$V4,26:3,27:2,28:1},{1:[3]},{3:7,4:$V0,5:$V1,6:$V2,7:$V3,8:5,23:4,24:$V4,26:13,29:[1,12]},o($V5,[2,25]),o($V5,[2,23]),o([24,29],[2,24],{3:14,4:$V0,5:$V1,6:$V2,7:$V3}),{6:[1,15]},o($V5,[2,5]),o($V5,[2,1]),o($V5,[2,2]),o($V5,$V6),o($V5,[2,4]),{1:[2,27]},o($V5,[2,26]),o($V5,[2,6]),{6:[1,20],14:18,20:19,21:17,22:16},{6:[1,21],14:18,20:19,21:22},{6:[2,20]},{6:[2,18]},{6:[2,19]},{3:7,4:$V0,5:$V1,6:$V2,7:$V3,8:23,15:24,16:$V7,17:$V8,18:$V9,19:$Va},{3:7,4:$V0,5:$V1,6:$V2,7:$V3,8:23,15:24,16:$V7,17:$V8,18:$V9,19:$Va,25:[1,29]},{6:[2,21]},{3:14,4:$V0,5:$V1,6:[1,30],7:$V3},{6:[2,17]},{6:[2,13]},{6:[2,14]},{6:[2,15]},{6:[2,16]},o($V5,[2,22]),o($Vb,$V6,{13:31,12:32,9:33,10:$Vc,11:$Vd}),{6:[2,12],9:33,10:$Vc,11:$Vd,12:36},o($Ve,[2,10]),{3:7,4:$V0,5:$V1,6:$V2,7:$V3,8:37},o($Vb,[2,7]),o($Vb,[2,8]),o($Ve,[2,11]),{3:14,4:$V0,5:$V1,6:[1,38],7:$V3},o([4,5,7],$V6,{6:$Vf,10:$Vf,11:$Vf})],
