...
yy: {},
symbols_: {"error":2,"expressions":3,"block":4,"EOF":5,"word":6,"char":7,"sequence":8,",":9,"answer":10,"{{":11,"}}":12,"option":13,"::":14,"$accept":0,"$end":1},
terminals_: {2:"error",5:"EOF",7:"char",9:",",11:"{{",12:"}}",14:"::"},
productions_: [0,[3,2],[6,1],[6,2],[8,3],[8,3],[10,1],[10,1],[4,3],[4,5],[4,5],[13,1]],
performAction: function anonymous(yytext, yyleng, yylineno, yy, yystate, $$, _$) {
/* this == yyval */
...
case 4:this.$ = [$$[$0-2],$$[$0]]
break;
case 5:$$[$0-2].push($$[$0]); this.$ = $$[$0-2];
break;
case 8:this.$ = {items: $$[$0-1]}
break;
case 9:this.$ = {items: '<select>' + '<option>' + 'select answer' + $$[$0-3] + '</option>' + '</select>', word: $$[$0-1]}
break;
case 10:this.$ = {items: '<input>', answer: $$[$0-1]}
break;
case 11:var opts = $$[$0].map(function(item) {return '<option>' + item + '</option>';}); this.$ = opts
break;
}
},
table: [{3:1,4:2,11:[1,3]},{1:[3]},{5:[1,4]},{6:8,7:[1,7],8:5,13:6},{1:[2,1]},{9:[1,10],12:[1,9],14:[2,11]},{14:[1,11]},{7:[2,2],9:[2,2],14:[1,12]},{7:[1,14],9:[1,13]},{5:[2,8]},{6:15,7:[1,16]},{6:17,7:[1,16]},{6:19,7:[1,16],8:20,10:18},{6:21,7:[1,16]},{7:[2,3],9:[2,3],12:[2,3],14:[2,3]},{7:[1,14],9:[2,5],12:[2,5],14:[2,5]},{7:[2,2],9:[2,2],12:[2,2],14:[2,2]},{7:[1,14],12:[1,22]},{12:[1,23]},{7:[1,14],9:[1,13],12:[2,6]},{9:[1,10],12:[2,7]},{7:[1,14],9:[2,4],12:[2,4],14:[2,4]},{5:[2,9]},{5:[2,10]}],
defaultActions: {4:[2,1],9:[2,8],22:[2,9],23:[2,10]},
...
break;
case 3:return 9   //items separator
break;
case 4:return 11  //start block
break;
case 5:return 12  //end block
break;
